...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/sub-page/': RouteRecordInfo<
      ...
      | never
    >,
    '/sub-page/the-second': RouteRecordInfo<
      '/sub-page/the-second',
      '/sub-page/the-second',
      Record<never, never>,
      Record<never, never>,
  ...
  export interface _RouteFileInfoMap {
    ...
    'src/pages/02_about.vue': {
      routes:
        | '/about'
      views:
        | never
    }
    'src/pages/01_index.vue': {
      routes:
        | '/index'
      views:
        | never
    }
    'src/pages/03-setting.vue': {
      routes:
        | '/setting'
      views:
        | never
    }
    'src/pages/04_sub-page/index.vue': {
      routes:
        | '/sub-page/'
      views:
        | never
    }
    'src/pages/04_sub-page/the-second.vue': {
      routes:
        | '/sub-page/the-second'
      views:
        | never
