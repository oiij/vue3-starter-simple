...
export default defineConfig({
  ...
  prompt: {
    ...
    types: [
      ...
      { value: 'refactor', name: 'refactor: 🔄 代码重构 | A code change that neither fixes a bug nor adds a feature', emoji: ':arrows_counterclockwise:' },
      { value: 'perf', name: 'perf:     ⚡️ 性能提升 | A code change that improves performance', emoji: ':zap:' },
      { value: 'type', name: 'type:     🎨 类型变更 | Changes that affect the type of the code', emoji: ':art:' },
